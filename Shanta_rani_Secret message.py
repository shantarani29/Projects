...
# Buttons
Button(root, text="Encrypt", command=encrypt_message, bg="Red", font=("Helvetica", 12)).pack(pady=10)
Button(root, text="Decrypt", command=decrypt_message, bg="Blue", font=("Helvetica", 12)).pack(pady=10)
